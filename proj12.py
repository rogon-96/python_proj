...
def generateMarksheet(mrks,wmrks):
    ...
    for i in range(len(response)):       
        ...
        sheet.cell(row=10,column=2).font = Font(color="00FF0000")
        sheet.cell(row=11,column=2).font = Font(color="00FF0000")
        sheet.cell(row=12,column=2).font = Font(color="00FF0000")
        sheet.cell(row=10,column=3).font = Font(color="00008000")
        sheet.cell(row=11,column=3).font = Font(color="00008000")
        sheet.cell(row=12,column=3).font = Font(color="00008000")
        ...
        seclist = [[10,2,rgt],[11,2,mrks],[12,2,rgt*mrks],[10,3,wrg],[11,3,wmrks],[12,3,wrg*wmrks],[10,4,na],[11,4,0],[10,5,rgt+wrg+na],[12,5,str(rgt*mrks+wrg*wmrks)+'/'+str(len(crt)*mrks)]]
        for s in seclist:
            sheet.cell(row=s[0],column=s[1]).value = s[2]
            sheet.cell(row=s[0],column=s[1]).alignment = alignment
